    ...
    return (
        ...
        <div className="flex gap-6 items-center">
          <Image
            ...
            className="w-9 h-9"
          />
          <Link href="/" className="bg-background w-11 h-11 grid place-items-center rounded-full text-3xl text-white">
            <MdHomeFilled/>
          </Link>
          <div className="bg-backgroud hidden lg:flex items-center h-11 w-90 px-3 gap-3 rounded-full text-primary-text">
            ...
            <input type="text" placeholder="What do you want to play?" className="w-full h-full bg-background placeholder:text-primary-text outline-none"/>
          </div>
        </div>
        ...
        <div className="flex gap-8 items-center">
          ...
          <div>
            <Link href="/login" className="bg-white text-gray-950 rounded-full font-bold hover:bg-secondary-text px-8 py-2 grid place-items-center">Login</Link>
          </div>
        </div>
      </nav>
    )
